...
export const de: Messages = {
  ...
  "settings.lanpage_host.hint": "Adresse der LANPage (Standard: launcher.lan). Von dort lädt der Launcher launcher.ini: den Namen der LAN für die Kopfzeile, Farben und die Statistik-Adresse. Ohne diese Datei ändert sich nichts; die Diagnose meldet es.",
  "settings.lanpage_host.loaded": "LANPage {host} geladen.",
  "settings.lanpage_host.not_found": "Unter {host} wurde keine launcher.ini gefunden.",
