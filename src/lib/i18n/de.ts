...
export const de: Messages = {
  ...
  "detail.install_path": "Installationspfad",
  "detail.genre": "Genre",
  ...
  "detail.runner": "Kompatibilitätsversion",
  "detail.runner_auto": "Automatisch (empfohlen)",
  "detail.runner_missing": "Gewählte Version nicht mehr verfügbar",
  "detail.runner_hint": "Jede manuell gewählte Version verwendet eine eigene Kompatibilitätsumgebung. Beim Zurückwechseln bleiben Spielstände und Einstellungen erhalten.",
  ...
  "diag.web_ui": "Resilio-Oberfläche",
  "diag.web_ui.hint": "Öffnet die Weboberfläche des Sync-Dienstes im Browser.",
  "diag.web_ui.unavailable": "Der Sync-Dienst läuft noch nicht.",
  "diag.launch.title": "Letzter Start: {game}",
  "diag.launch.when": "Wann",
  "diag.launch.program": "Programm",
  "diag.launch.command": "Befehlszeile",
  "diag.launch.cwd": "Arbeitsverzeichnis",
  "diag.launch.result": "Ergebnis",
  "diag.launch.output": "Ausgabe",
  "diag.launch.retry_logged": "Mit Protokoll starten",
  "diag.launch.rerun_setup": "Einrichtung mit Protokoll wiederholen",
  "diag.launch.retry_started": "Startet erneut — das Fenster des Spiels bleibt dabei leer, die Ausgabe steht hier.",
  "diag.launch.output.empty": "Nicht aufgezeichnet — das Spiel behält sein eigenes Fenster. Für eine Aufzeichnung oben „Mit Protokoll starten“.",
  "diag.launch.output.nothing": "Aufgezeichnet, aber das Programm hat nichts ausgegeben.",
  ...
  "diag.launch.elevated": "mit Adminrechten",
  "diag.restart_transport": "Resilio neu starten",
  ...
  "settings.library.hint":
    "Du kannst mehrere Ordner (z. B. auf verschiedenen SSDs) verwenden. Neue Spiele landen im Standard-Ordner; ist dort zu wenig Platz, im Ordner mit dem meisten freien Platz. Der Standard-Ordner enthält den Katalog.",
  "settings.library.add": "Ordner hinzufügen",
  "settings.library.default": "✓ Standardordner",
  ...
  "wizard.step1.text": "Übernimm den vorgeschlagenen Ordner oder ergänze eigene Spiele-Ordner. In allen Ordnern suchen wir nach einer vorhandenen Datenbank unter eti_launcher/update/game.db. Der Standardordner erhält den neuen Katalog-Download.",
  ...
  "status.rates": "Übertragungsrate über alle Freigaben",
  "status.free": "{free} frei",
  "status.problems": "Hinweise: {count}",
  ...
  "toast.runner_saved": "Kompatibilitätsversion gespeichert",
  ...
  "msg.folder_opened": "Ordner geöffnet.",
  "msg.link_opened": "Im Browser geöffnet.",
  ...
  "problem.transport.no_peers.action": "Resilio neu starten",
  ...
  "problem.transport.no_server.action": "Resilio neu starten",
  ...
  "problem.transport.start_failed.action": "Download-Seite öffnen",
  "problem.transport.start_failed.step.install": "Resilio Sync installieren (Link über „Download-Seite öffnen“) und den Launcher neu starten.",
  ...
  "problem.catalog.loading.title": "Spieledatenbank wird geladen – bitte warten",
  "problem.catalog.loading.cause": "{state} Die Spieleliste erscheint automatisch, sobald die Datenbank bereit ist.",
  "problem.catalog.loading.step.wait": "Bitte warten. Diese Anzeige aktualisiert sich automatisch. Prozentwerte beziehen sich auf die gesamte Katalog-Freigabe einschließlich Zusatzdateien.",
  "catalog.state.connecting": "Verbindung zum Katalog wird aufgebaut.",
  "catalog.state.indexing": "Katalog-Freigabe wird eingelesen.",
  "catalog.state.downloading": "Katalog-Freigabe wird heruntergeladen.",
  "catalog.state.reading": "Katalog-Freigabe ist empfangen; Datenbank wird eingelesen.",
  "problem.catalog.missing.cause": "Der Katalog-Ordner eti_launcher wurde noch nicht vom Sync-Server empfangen.",
  "problem.catalog.missing.step.wait": "Die Anzeige prüft automatisch erneut. Bei pausierter Freigabe in „Sync-Oberfläche“ den Ordner eti_launcher fortsetzen; im Ordnermodus dessen Synchronisierung im eigenen Sync-Client prüfen.",
  "problem.catalog.missing.step.peers": "Weitere Netzwerkhinweise beheben. Bleibt die Spieleliste leer, Sync-Dienst neu starten oder bei der Orga prüfen, ob der Katalog auf dem Server freigegeben ist.",
